...
class StockRepository:
    ...
    def _init_facets(self):
        self.on_iex_blacklist = on_iex_blacklist
        self.get_historical_daily_security_prices = get_historical_daily_security_prices
        self.get_historical_intraday_security_prices = get_historical_intraday_security_prices
        self.fetch_historical_daily = fetch_historical_daily
        self.fetch_historical_intraday = fetch_historical_intraday
        self.create_historical_daily_security_price = create_historical_daily_security_price
        self.create_historical_intraday_security_price = create_historical_intraday_security_price
